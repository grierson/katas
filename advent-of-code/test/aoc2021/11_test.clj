...
(deftest step-test
  (testing "smaller sample step"
    (let [init {:grid    (str->grid ["11111"
                                     "19991"
                                     "19191"
                                     "19991"
                                     "11111"])
                :flashes 0}
          step1 {:grid    (str->grid ["34543"
                                      "40004"
                                      "50005"
                                      "40004"
                                      "34543"])
                 :flashes 9}
          step2 {:grid    (str->grid ["45654"
                                      "51115"
                                      "61116"
                                      "51115"
                                      "45654"])
...
(deftest bigger-step-test
  (testing "bigger sample step"
    (let [init {:grid    (str->grid ["5483143223"
                                     "2745854711"
                                     "5264556173"
                                     "6141336146"
                                     "6357385478"
                                     ...
                                     "5283751526"])
                :flashes 0}
          step1 {:grid (str->grid ["6594254334"
                                   "3856965822"
                                   "6375667284"
                                   "7252447257"
                                   "7468496589"
                                   ...
                                   "6394862637"])
                 :flashes 0}
          step2 {:grid (str->grid ["8807476555"
                                   "5089087054"
                                   "8597889608"
                                   "8485769600"
                                   "8700908800"
...
(deftest sample-100-test
  (testing "sample to 100 steps"
    (let [init {:grid    (str->grid ["5483143223"
                                     ...
                                     "5283751526"])
                :flashes 0}
          step100 {:grid    (str->grid ["0397666866"
                                        "0749766918"
                                        "0053976933"
                                        "0004297822"
                                        "0004229892"
